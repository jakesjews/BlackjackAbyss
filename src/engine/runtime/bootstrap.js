...
export function bootstrapRuntime() {
  ...
  function updateMobileControls() {
    ...
    const canDouble = canDoubleDown({
      canAct: state.mode === "playing" && canAct,
      encounter: state.encounter,
    });
  ...
  function registerPhaserMenuActions() {
    ...
    assertApiContract(api, MENU_API_METHODS, "menu");
    phaserBridge.setMenuActions(api);
  }
  ...
  function registerPhaserRunApi() {
    ...
    assertApiContract(api, RUN_API_METHODS, "run");
    phaserBridge.setRunApi(api);
  }
  ...
  function registerPhaserRewardApi() {
    ...
    assertApiContract(api, REWARD_API_METHODS, "reward");
    phaserBridge.setRewardApi(api);
  }
  ...
  function registerPhaserShopApi() {
    ...
    assertApiContract(api, SHOP_API_METHODS, "shop");
    phaserBridge.setShopApi(api);
  }
  ...
  function registerPhaserOverlayApi() {
    ...
    assertApiContract(api, OVERLAY_API_METHODS, "overlay");
    phaserBridge.setOverlayApi(api);
  }
